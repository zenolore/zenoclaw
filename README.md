...
- **🆕 Live Status Overlay** — Real-time floating status bar with platform task label, step counter, current/next action preview, and color-coded states (orange/red for in-progress, green pulse for done); Shadow DOM anti-detection design
...
> 📖 For complete request/response schemas, SDK methods, and code examples, see **[API Reference (English)](API_REFERENCE.md)** | **[接口参考文档 (中文)](API_REFERENCE_CN.md)**
...
| `GET` | `/api/platforms/health` | Platform health matrix |
